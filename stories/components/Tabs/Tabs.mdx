...
✅ `role="tablist"`로 설정되어 있습니다.

### Tab Item

✅ `role="tab"`으로 설정되어 있습니다.  
...
✅ 연결된 탭 버튼의 ID를 참조하는 `aria-labelledby`가 설정되어 있습니다.
...
<div className="keyboard">Arrow Right</div>

- 다음 탭 버튼으로 포커스를 이동시킵니다.

<div className="keyboard">Arrow Left</div>
