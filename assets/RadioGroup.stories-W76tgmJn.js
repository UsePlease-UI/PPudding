import{j as c}from"./iframe-BLazJ4V0.js";import{R as r}from"./index-BlNKi0yD.js";const{useArgs:g}=__STORYBOOK_MODULE_PREVIEW_API__,{expect:o,within:m}=__STORYBOOK_MODULE_TEST__,R={args:{children:null,gap:10,isRow:!0,value:"red"},argTypes:{children:{control:!1,description:"radio component",table:{type:{summary:"ReactNode"}}},className:{table:{disable:!0}},gap:{control:"number",description:"horizontal / vertical spacing of the component"},isRow:{control:"boolean",description:"if true, the component be shown horizontally"},onChange:{control:!1,description:"change event handler",table:{type:{summary:"(e: ChangeEvent<HTMLInputElement>) => void"}}},value:{control:!1,description:"selected radio's value",table:{type:{summary:"string"}},type:"string"}},component:r.Group,parameters:{layout:"centered"},tags:["autodocs"],title:"Form/Radio/UI - 1. Radio Group"},t={args:{gap:10,isRow:!0,value:"red"},play:async({canvasElement:i})=>{const e=m(i),a=e.getByRole("radiogroup");await o(a).toBeInTheDocument(),await o(a).toHaveStyle("flex-direction: row");const n=e.getByRole("radio",{name:"빨강"});await o(n).toBeChecked();const s=e.getByRole("radio",{name:"파랑"});await o(s).not.toBeChecked()},render:function(e){const[{value:a},n]=g(),s=l=>{n({value:l})};return c.jsxs(r.Group,{...e,value:a,onChange:l=>s(l.currentTarget.value),children:[c.jsx(r,{label:"빨강",name:"color",value:"red"}),c.jsx(r,{label:"파랑",name:"color",value:"blue"})]})}};var d,u,p;t.parameters={...t.parameters,docs:{...(d=t.parameters)==null?void 0:d.docs,source:{originalSource:`{
  args: {
    gap: 10,
    isRow: true,
    value: 'red'
...
}`,...(p=(u=t.parameters)==null?void 0:u.docs)==null?void 0:p.source}}};const y=["Default"];export{t as Default,y as __namedExportsOrder,R as default};
