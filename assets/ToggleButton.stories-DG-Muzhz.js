import{j as r}from"./iframe-BuoardWh.js";import{T as a}from"./index-B4zzLPRx.js";import{F as S,a as v}from"./ItalicIcon-CCJYkkjv.js";import"./styles-8MddfzVJ.js";const j={args:{isDisabled:!1,size:"large",value:"bold"},argTypes:{currentValue:{table:{disable:!0}},isDisabled:{control:"boolean",description:"if true, the component will be disabled"},isMultiple:{table:{disable:!0}},name:{control:"text",description:"name attribute of the input element",table:{type:{summary:"string"}}},onChange:{table:{disable:!0}},size:{control:{type:"inline-radio"},description:"toggle button size",options:["large","medium","small"]},value:{control:"text",description:"toggle button value",table:{type:{summary:"string"}}}},component:a,parameters:{layout:"centered"},tags:["autodocs"],title:"Button/ToggleButton/UI - 2. ToggleButton"},t={args:{size:"large",value:"banana"},render:function(e){return r.jsx(a,{currentValue:"banana",...e,children:"Banana"})}},n={args:{size:"large",value:"orange"},render:function(e){return r.jsx(a,{currentValue:"banana",...e,children:"Orange"})}},o={args:{size:"large",value:"bold"},render:function(e){return r.jsx(a,{"aria-label":"bold",currentValue:"bold",...e,children:r.jsx(S,{})})}},l={args:{size:"large",value:"italic"},render:function(e){return r.jsx(a,{"aria-label":"italic",currentValue:"bold",...e,children:r.jsx(v,{})})}};var u,c,i;t.parameters={...t.parameters,docs:{...(u=t.parameters)==null?void 0:u.docs,source:{originalSource:`{
  args: {
    size: 'large',
    value: 'banana'
  },
