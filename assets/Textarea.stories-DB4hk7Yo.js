import{j as i,r as d}from"./iframe-BLazJ4V0.js";import{F as f}from"./FormControl-CsYyvQ2d.js";import{T as l}from"./Textarea-DE_XKSJA.js";const{useArgs:I}=__STORYBOOK_MODULE_PREVIEW_API__,C={args:{isAutoHeight:!0,isDisabled:!1,isError:!1,isReadOnly:!1},argTypes:{isAutoHeight:{control:"boolean",description:"if true, height will automatically increase, without being fixed"},isDisabled:{control:"boolean",description:"if true, the component will be disabled"},isError:{control:"boolean",description:"if true, the component will indicate error"},isReadOnly:{control:"boolean",description:"if true, user cannot change the value of the component"},value:{table:{disable:!0}}},component:l,parameters:{layout:"centered"},tags:["autodocs"],title:"Form/Textarea"},t={args:{isAutoHeight:!1,value:"Lorem ipsum dolor sit amet, consectetur adipiscing elit."},render:function(o){const[{value:s},n]=I(),r=e=>{n({value:e})};return i.jsx(l,{...o,maxLength:100,value:s,isAutoHeight:!0,onChange:e=>r(e.currentTarget.value),placeholder:"Lorem Ipsum..."})}},a={args:{isAutoHeight:!0,value:"Lorem ipsum dolor sit amet, consectetur adipiscing elit."},render:function(o){const[{value:s},n]=I(),r=d.useId(),e=d.useId(),T=u=>{n({value:u})};return i.jsx(f,{helperText:"Type Lorem Ipsum",helperTextId:e,inputId:r,labelText:"Lorem Ipsum",children:i.jsx(l,{...o,"aria-describedby":e,id:r,maxLength:2e3,value:s,onChange:u=>T(u.currentTarget.value),placeholder:"Lorem Ipsum..."})})}};var c,p,m;t.parameters={...t.parameters,docs:{...(c=t.parameters)==null?void 0:c.docs,source:{originalSource:`{
  args: {
    isAutoHeight: false,
