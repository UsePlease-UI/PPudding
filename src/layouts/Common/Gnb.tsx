...
export default function Gnb({ onClick }: GnbType) {
    ...
    return (
        <header className="fixed left-0 right-0 top-0 z-1 h-20 border-b border-b-primary-100 bg-white px-5 tablet:shadow-02 under-tablet:h-14 under-tablet:px-2.5">
