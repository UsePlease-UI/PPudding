  ...
  return (
    <div className={customStyles.playgroundContainer}>
      <div className={customStyles.playgroundControlContainer}>
        ...
        <RadioControls name="icon button shape" options={BUTTON_SHAPE} value={shapeType} onChange={setShapeType} />
      </div>
      <div className={customStyles.playgroundDisplayContainer}>
        <IconButton shape={shapeType as ShapeType} size={sizeType as SizeType} variant={variantType as VariantType}>
          <CheckmarkFilled />
        </IconButton>
      </div>
    </div>
